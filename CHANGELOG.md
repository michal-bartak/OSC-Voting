...
- **Linux** — the vote popup is positioned to match where each desktop shows
...
- **Linux** — the vote popup now matches the app's theme when the system is in
  dark mode (previously it could appear light over a dark app).
